...
export const serviceCardRootTV = tv({
  base: `relative shadow-2xl shadow-secondary w-full max-w-[300px] h-fit mb-4 rounded-3xl bg-primary flex flex-col items-center py-2 md:py-4 px-3 md:px-8 justify-center gap-1 md:gap-4
